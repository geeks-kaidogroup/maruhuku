...
$loop = new WP_Query( array( 'post_type' => 'blog','p' => $post->ID, 'posts_per_page' => 1,	'paged'=>$paged ) );
...
<?php endwhile; ?>
<?php wp_reset_query(); ?>
				<div class="pager"><p><?php previous_post_link('%link','＜＜前の記事'); ?><a href="<?php echo home_url('/blog/'); ?>" class="centerlink">一覧へ戻る</a><?php next_post_link('%link','次の記事＞＞'); ?></p></div>
			</article>	<!--/article-->
